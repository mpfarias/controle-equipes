...
import { MulherOrigemOcorrencia } from '@prisma/client';
...
/** Linha da planilha → registro `mulher_ocorrencia`; null se sem nome da vítima. */
export function sheetRowToMulherOcorrencia(
  headers: string[],
  row: unknown[],
): Prisma.MulherOcorrenciaCreateManyInput | null {
  ...
  return {
    origem: MulherOrigemOcorrencia.IMPORTACAO_EXCEL,
    faseAtual,
    concluida,
    ...
    encaminhamentoDetalhes: undefined,
...
export const MULHER_XLSX_READ_OPTS = {
  cellDates: true,
  cellNF: false,
  cellStyles: false,
  cellFormula: false,
...
export const MULHER_EXCEL_BATCH_SIZE = 1200;
