-- Idempotente: MotivoAfastamento + Afastamento.motivoId (substitui coluna texto "motivo" quando existir).
-- Suporta banco vazio, dados legados e reexecução após falha parcial.
DO $$
DECLARE
