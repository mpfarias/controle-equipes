import type { LoginInput, OrionAssessoriaPublicInfo, OrionAssessoriaSessao, Usuario } from './types';
import {
...
export const api = {
  async getPublicInfo(): Promise<OrionAssessoriaPublicInfo> {
    return request<OrionAssessoriaPublicInfo>('/orion-assessoria');
  },

  async getSessaoModulo(): Promise<OrionAssessoriaSessao> {
    return request<OrionAssessoriaSessao>('/orion-assessoria/v1/sessao');
  },
