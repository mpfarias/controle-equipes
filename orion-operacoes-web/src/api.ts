import type { LoginInput, OrionOperacoesPublicInfo, OrionOperacoesSessao, Usuario } from './types';
import {
...
export const api = {
  async getPublicInfo(): Promise<OrionOperacoesPublicInfo> {
    return request<OrionOperacoesPublicInfo>('/orion-operacoes');
  },

  async getSessaoModulo(): Promise<OrionOperacoesSessao> {
    return request<OrionOperacoesSessao>('/orion-operacoes/v1/sessao');
  },
