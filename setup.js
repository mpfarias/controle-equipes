...
async function main() {
  ...
  logStep('9/10', 'Apps Órion (Suporte, Qualidade, Jurídico, Patrimônio, Mulher, Agenda, Operações): .env e dependências...');
  ...
  log('   Raiz: npm run start:full  → API + SAD + Órion Suporte + Qualidade + Jurídico + Patrimônio + Mulher + Agenda + Operações', 'yellow');
  ...
  log('   7. npm run start:orion-agenda (porta 5186)', 'yellow');
  ...
  log('   Agenda: http://localhost:5186', 'green');
