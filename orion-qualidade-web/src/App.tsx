...
import type { OrionQualidadePublicInfo, OrionQualidadeSessao, Usuario } from './types';

const DOC_TITLE = 'Órion Qualidade';

export default function App() {
  const [publicInfo, setPublicInfo] = useState<OrionQualidadePublicInfo | null>(null);
  const [publicErr, setPublicErr] = useState<string | null>(null);
  const [sessaoModulo, setSessaoModulo] = useState<OrionQualidadeSessao | null>(null);
