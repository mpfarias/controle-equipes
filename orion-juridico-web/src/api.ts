import type { LoginInput, OrionJuridicoPublicInfo, OrionJuridicoSessao, Usuario } from './types';
import {
...
export const api = {
  async getPublicInfo(): Promise<OrionJuridicoPublicInfo> {
    return request<OrionJuridicoPublicInfo>('/orion-juridico');
  },

  async getSessaoModulo(): Promise<OrionJuridicoSessao> {
    return request<OrionJuridicoSessao>('/orion-juridico/v1/sessao');
  },
